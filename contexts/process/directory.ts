...
import { XP_ICONS } from "components/constants";
...
const directory: Processes = {
  ...
  Browser: {
    ...
    icon: "/edge-custom.webp",
    title: "Browser",
  },
  Camera: {
    Component: dynamic(() => import("components/apps/Camera")),
  ...
  ContactMe: {
    Component: dynamic(() => import("components/apps/ContactMe")),
  ...
  PortfolioTerminal: {
    Component: dynamic(() => import("components/apps/PortfolioTerminal")),
    backgroundBlur: "8px",
  ...
  Resume: {
    Component: dynamic(() => import("components/apps/Resume")),
    backgroundColor: "#525252",
    defaultSize: {
      height: 640,
      width: 900,
    },
    icon: XP_ICONS.resume,
    title: "My Resume",
  },
  Ruffle: {
  ...
  SmashKarts: {
    ...
    icon: "/System/Icons/smash-karts-logo.png",
    initialTitle: "Smash Karts",
    title: "Smash Karts",
    url: "https://smashkarts.io/",
  },
  Spotify: {
    Component: dynamic(() => import("components/apps/Spotify")),
    backgroundColor: "#121212",
    defaultSize: {
      height: 430,
      width: 840,
    },
    icon: XP_ICONS.spotify,
    title: "Spotify",
  },
  StableDiffusion: {

...
const FILE_TYPE = 0x8000;
const FILE_MODE = 0x1a4;
...
const createFileStat = (
  ...
  ({
    ...
    isFIFO: () => false,
    isFile: () => (mode & 0xf000) === FILE_TYPE,
    isSocket: () => false,
    isSymbolicLink: () => (mode & 0xf000) === 0xa000,
    mode: mode < 0x1000 ? mode | FILE_TYPE : mode,
